...
if __name__ == "__main__":
    ...
    plt.savefig('images/AMDFFTGUI_5_1024.png')
    ...
    g.set(xlabel='Muestras/Paquete')
    g.set(ylabel='Tiempo de ejecución (s)')
    plt.savefig('images/AMDFFTGUI_5_8192.png')
    ...
    g.set(xlabel='Muestras/Paquete')
    g.set(ylabel='Tiempo de ejecución (s)')
    plt.savefig('images/AMDFFTGUI_20_1024.png')
    ...
    g.set(xlabel='Muestras/Paquete')
    g.set(ylabel='Tiempo de ejecución (s)')
    plt.savefig('images/AMDFFTGUI_20_8192.png')
